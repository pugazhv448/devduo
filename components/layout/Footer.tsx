      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 text-light">
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-3">
            ...
            <li>
              <a href="https://wa.me/917339097430" target="_blank" rel="noopener noreferrer" className="text-light/60 hover:text-accent transition-colors text-sm flex items-center gap-1">
